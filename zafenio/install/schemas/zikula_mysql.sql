...
CREATE TABLE zk_zafenio_attachments (
...
CREATE TABLE zk_zafenio_acl_groups (
...
CREATE TABLE zk_zafenio_acl_options (
...
CREATE TABLE zk_zafenio_acl_roles (
...
CREATE TABLE zk_zafenio_acl_roles_data (
...
CREATE TABLE zk_zafenio_acl_users (
...
# Table: 'phpbb_banlist'
CREATE TABLE zk_zafenio_banlist (
...
# Table: 'phpbb_bbcodes'
CREATE TABLE zk_zafenio_bbcodes (
...
CREATE TABLE zk_zafenio_bookmarks (
	topic_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
...
# Table: 'phpbb_config'
CREATE TABLE zk_zafenio_config (
...
# Table: 'phpbb_confirm'
CREATE TABLE zk_zafenio_confirm (
...
CREATE TABLE zk_zafenio_disallow (
...
# Table: 'phpbb_drafts'
CREATE TABLE zk_zafenio_drafts (
...
CREATE TABLE zk_zafenio_extensions (
...
CREATE TABLE zk_zafenio_extension_groups (
...
# Table: 'phpbb_forums'
CREATE TABLE zk_zafenio_forums (
...
CREATE TABLE zk_zafenio_forums_access (
	forum_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	session_id char(32) DEFAULT '' NOT NULL,
...
CREATE TABLE zk_zafenio_forums_track (
	user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	forum_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
...
CREATE TABLE zk_zafenio_forums_watch (
	forum_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
...
# Table: 'phpbb_groups'
CREATE TABLE zk_zafenio_groups (
	group_id mediumint(8) UNSIGNED NOT NULL auto_increment,
...
CREATE TABLE zk_zafenio_moderator_cache (
	forum_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
...
# Table: 'phpbb_modules'
CREATE TABLE zk_zafenio_modules (
...
CREATE TABLE zk_zafenio_poll_options (
...
CREATE TABLE zk_zafenio_poll_votes (
	topic_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	poll_option_id tinyint(4) DEFAULT '0' NOT NULL,
...
CREATE TABLE zk_zafenio_privmsgs (
...
CREATE TABLE zk_zafenio_privmsgs_folder (
...
CREATE TABLE zk_zafenio_privmsgs_rules (
...
CREATE TABLE zk_zafenio_privmsgs_to (
...
CREATE TABLE zk_zafenio_profile_fields (
...
CREATE TABLE zk_zafenio_profile_fields_data (
	user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	PRIMARY KEY (user_id)
) CHARACTER SET `utf8` COLLATE `utf8_bin`;
...
CREATE TABLE zk_zafenio_profile_fields_lang (
...
CREATE TABLE zk_zafenio_profile_lang (
	field_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	lang_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
...
# Table: 'phpbb_reports'
CREATE TABLE zk_zafenio_reports (
...
CREATE TABLE zk_zafenio_reports_reasons (
...
CREATE TABLE zk_zafenio_search_results (
...
CREATE TABLE zk_zafenio_search_wordlist (
...
CREATE TABLE zk_zafenio_search_wordmatch (
	post_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
...
CREATE TABLE zk_zafenio_sessions (
	session_id char(32) DEFAULT '' NOT NULL,
...
CREATE TABLE zk_zafenio_sessions_keys (
...
CREATE TABLE zk_zafenio_sitelist (
...
# Table: 'phpbb_smilies'
CREATE TABLE zk_zafenio_smilies (
...
# Table: 'phpbb_styles'
CREATE TABLE zk_zafenio_styles (
...
CREATE TABLE zk_zafenio_styles_template (
...
CREATE TABLE zk_zafenio_styles_template_data (
	template_id smallint(4) UNSIGNED DEFAULT '0' NOT NULL,
...
CREATE TABLE zk_zafenio_styles_theme (
...
CREATE TABLE zk_zafenio_styles_imageset (
...
CREATE TABLE zk_zafenio_styles_imageset_data (
...
# Table: 'phpbb_topics'
CREATE TABLE zk_zafenio_topics (
...
CREATE TABLE zk_zafenio_topics_track (
	user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	topic_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	forum_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	mark_time int(11) UNSIGNED DEFAULT '0' NOT NULL,
...
CREATE TABLE zk_zafenio_topics_posted (
	user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	topic_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
...
CREATE TABLE zk_zafenio_topics_watch (
	topic_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	notify_status tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
	KEY topic_id (topic_id),
...
CREATE TABLE zk_zafenio_user_group (
	group_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	user_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
...
CREATE TABLE zk_zafenio_warnings (
