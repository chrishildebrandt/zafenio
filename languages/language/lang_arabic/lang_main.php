...
$lang['13'] = 'GMT + 13 ÓÇÚÉ';
$lang['Confirm_code'] = 'ßæÏ ÇáÊÃßíÏ';
$lang['Confirm_code_explain'] = 'ÃÏÎá ÇáßæÏ ÊãÇãÇ ßãÇ ÊÑÇå¡ ÇáÕİÑ Èå ÎØ ŞØÑí¡ áÇÍÙ ÇáİÑŞ Èíä ÇáÍÑæİ ÇáßÈíÑÉ æÇáÕÛíÑÉ';
$lang['Confirm_code_impaired'] = 'ÅĞÇ ßäÊ áÇÊÓÊØíÚ ŞÑÇÁÉ ÇáßæÏ áÃí ÓÈÈ ãä ÇáÇÓÈÇÈ íÑÌì ãÑÇÓáÉ  %sAdministrator%s ááãÓÇÚÏÉ';
$lang['Confirm_code_wrong'] = 'ÇáßæÏ ÇáĞí ÃÏÎáÊ ÎÇØíÁ';
$lang['Too_many_registers'] = 'áŞÏ ÊÌÇæÒÊ ÚÏÏ ÇáãÑÇÊ ÇáãÓãæÍ ÈåÇ áãÍÇæáÉ ÇáÊÓÌíá İí åĞå ÇáãÑÉ íÑÌì ãÍÇæáÉ ÇáÊÓÌíá áÇÍŞÇ';
$lang['Too_many_registers'] = 'áŞÏ ŞãÊ ÈãÍÇæáÇÊ ÊÓÌíá İÇÔáÉ ßËíÑÉ¡ íÑÌì ÇáãÍÇæáÉ áÇÍŞÇ';
