...
$faq[] = array("Como agrego un adjunto luego de haber enviado el post?", "Para agregar un adjunto luego de haber enviado el post debera editar el mismo y seguir los procedimientos antes descriptos. Los nuevos adjuntos seran agregados cuando haga click en <i>Enviar</i> para enviar el post editado.");
...
$faq[] = array("Porque no veo el adjunto en mi post?", "Probablemente la extension del archivo no se permite en el foro, el moderador o administrador del foro lo ha deshabilitado por no cumplir con la politica del foro.");
