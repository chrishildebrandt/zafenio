...
// Installation
$lang['PNphpBB2_Install'] = "PNphpBB2 Instalación";
$lang['PNphpBB2_Install_Title'] = "<h4>Instalando tabla de PNphpBB2 a " . $table_prefix . '*</h4>';
$lang['PNphpBB2_Install_Complete'] = '<p><b>Instalación básica de PNphpBB2 está completa.<br /><br />Haz click en  "' . $lang['Finish_Install'] . '" para volver al módulo administrativo de PN, y activa PNphpBB2.<br /><br />Una vez activado puedes acceder a la administración del foro a través de la página de administración de PN (PNphpBB2) o con el enlace que está abajo del .<br /><br />Por favor cheakea los detalles en la Configuración General y realiza cualquier cambio requerido. Gracias por el elegir PNphpBB2.</b></p>';

// Update
$lang['PNphpBB2_Upgrade'] = "PNphpBB2 Actualización";
...
$lang['PNphpBB2_Move_Tables_Yes'] = "<h4>Moviendo tablas a su nueva ubicación</h4>";
$lang['PNphpBB2_Move_Complete'] = "<h4>Cambio completo a " . $table_prefix . "*</h4>";
$lang['PNphpBB2_Database_Type'] = "Tipo de Base de Datos";
$lang['PNphpBB2_Prev_Version'] = "Versión previa &nbsp;:: ";
$lang['PNphpBB2_Upgrade_Version'] = "Versión actualizada &nbsp;:: ";
$lang['PNphpBB2_Update_Schemas'] = "<h4>Updating database schema</h4>";
$lang['PNphpBB2_No_Updates'] =  "<h4>Ninguna actualización requerida</h4>";
$lang['PNphpBB2_Update_Data'] = "<h4>Datos actualizados</h4>";
$lang['PNphpBB2_Attach'] = "Attachment Mod Version ";
$lang['PNphpBB2_Updating_Paths'] = "<h4>Actualizando configuración de rutas</h4>";
...
$lang['PNphpBB2_Update_Complete'] = "<p><b>Actualización de PNphpBB2 está completa.<br /><br />";
...
$lang['PNphpBB2_Update_Complete'] .= "Antes de continuar, estás seguro de activar este módulo, revisa todos los ajustes de configuración en la página de administración.<br /><br />";
...
$lang['PNphpBB2_Remove_Text'] = 'Tu quieres remover PNphpBB2 y todas las tablas asociadas desde PostNuke (' . $table_prefix . '*).<br /><br />Todos los datos se perderan, ¿estás seguro de quere hacer esto?';
$lang['PNphpBB2_Remove_Title'] = "<h4>Removiendo tablas PNphpBB2 desde " . $table_prefix . '*</h4>';
$lang['PNphpBB2_Remove_Notes'] = "<p><b>Las tablas PNphpBB2 han sido quitadas. Para completar el proceso, regresa a la página de adminsitración de modulos y quita PNphpBB2 de nuevo.</b></p>";
...
$lang['PNphpBB2_No_Errors'] = "<h4>Ningún error</h4>";
