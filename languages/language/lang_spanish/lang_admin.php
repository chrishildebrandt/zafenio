...
$lang['Click_return_admin_index'] = 'Click %sAquí%s para retornar al Indice del Administrador';
...
$lang['Auth_updated'] = 'Los permisos han sido correctamente actualizados';
$lang['Click_return_userauth'] = 'Click %sAquí%s para vovler a ver los Permisos de los Usuarios';
$lang['Click_return_groupauth'] = 'Click %sAquí%s para vovler a ver los Permisos del Grupo';
$lang['Click_return_forumauth'] = 'Click %sAquí%s para vovler a ver los Permisos del Foro';
...
$lang['Ban_username_explain'] = 'Tú puedes banear a multiples usuarios usando la combinación apropiada de ratón y teclao de tu pc y navegador';
...
$lang['Click_return_banadmin'] = 'Click %sAquí%s para volver al Panel de Control de BANS';
...
$lang['Flood_Interval'] = 'Intervalo de posteo (Flood)';
$lang['Flood_Interval_explain'] = 'Cantidad de segundos que el usuario debe esperar para publicar mensajes';
...
$lang['Avatar_settings'] = 'Configuración de Avatar';
$lang['Allow_gravatars'] = 'Activar Gravatars';
...
$lang['Visual_confirm_explain'] = 'Requiere que el usuario introduzca un código definido por una imagen cuando este al registrarse.';

// Autologin Keys - added 2.0.18
$lang['Allow_autologin'] = 'Permitir login automático';
$lang['Allow_autologin_explain'] = 'Se determina si se permite a los usuarios seleccionar loggin automático al visitar el foro.';
$lang['Autologin_time'] = 'Caducidad de loggin automático';
$lang['Autologin_time_explain'] = 'Cuanto tiempo, la clave del autologgin, es válida en días si el usuario no visita el foro. Ajuste a cero para desactivar la caducidad.';

// Search Flood Control - added 2.0.20
$lang['Search_Flood_Interval'] = 'Intervalo de búsqueda (Flood)';
$lang['Search_Flood_Interval_explain'] = 'Número de segundos que el usuario debe esperar para realizar nueva búsqueda'; 
...
$lang['Forum_delete_explain'] = 'El siguiente formulario le permitirá Borrar algún foro (o categoría) y decir donde desea colocar todos los Temas y Categorías.';
...
$lang['prune_freq'] = 'Chequear temas y edad';//Ver Pruning!
$lang['prune_days'] = 'Remover Temas que no tienen respuesta';
...
$lang['Nowhere_to_move'] = 'En ninguna parte para moverse también';
...
$lang['export_smiles'] = 'Para crear un paquete de Smiles de sus smileys instalados, click %sAquí%s para bajar el archivo smiles.pak. Nombre este archivo de forma apropiada pero asegúrese de mantener la extension .pak. Luego cree un archivo zip que contenga todos los smileys más el archivo .pak.';
...
$lang['Click_return_smileadmin'] = 'Click %sAquí%s para volver al Panel de Smiles';

$lang['Confirm_delete_smiley'] = '¿Estas seguro de querer borrar este Smiley?';
...
$lang['User_delete_explain'] = 'Click aquí para borrar este Usuario. Tenga en cuenta que luego no podrá restaurarlo.';
...
//
$lang['Forum_Prune'] = 'Pruning de Foros';
$lang['Forum_Prune_explain'] = 'Esto borrará todos los temas en los que no se hayan publicado nuevos mensajes en los días que usted seleccionó. Si no ingresa un número entonces todos los temas serán borrados. No se borrarán temas en los que hay encuestas que estén corriendo ni anuncios. Tendrá que remover estos temas en forma manual.';
$lang['Do_Prune'] = 'Realizar el Pruning';
$lang['All_Forums'] = 'Todos los Foros';
$lang['Prune_topics_not_posted'] = 'Borrar temas sin respuestas de una antigüedad de estos días';
...
$lang['Word'] = 'Palabra';
$lang['Edit_word_censor'] = 'Editar el Censurador de Palabras';
$lang['Replacement'] = 'Reemplazar';
$lang['Add_new_word'] = 'Agregar nueva palabra';
$lang['Update_word'] = 'Actualizar censurador de palabras';
...
$lang['Confirm_delete_word'] = '¿Estas seguro de querer borrar esta palabra del Censurador de Palabras?';
...
$lang['No_update_ranks'] = 'El rango ha sido eliminado satisfactoriamente. Sin embargo, las cuentas de usuarios usando este rango no seran actualizadas. Tú necesitas resetear manualmente el rango en estas cuentas';

$lang['Click_return_rankadmin'] = 'Click %sAquí%s para volver al Panel de Adminstración de Rangos';

$lang['Confirm_delete_rank'] = '¿Estas seguro de querer borrar este rango?';
...
$lang['Click_return_disallowadmin'] = 'Click %sAqui%s para volver al Control de Admisión de Usuario';
...
$lang['Stylesheet_explain'] = 'Nombre de archivo para el CSS stylesheet para usar en este theme.';
...
// Install Process
//
$lang['Welcome_install'] = 'Bienvenidos a la Instalación de los foros PNphpBB2';
...
$lang['ftp_path'] = 'Ruta FTP al PNphpBB2';
...
$lang['Install_No_PCRE'] = 'PNphpBB2 requiere el módulo de expresiones regulares compatible con Perl para php, que no figura como soportado en su configuración de php!';

//
// Version Check
//
$lang['Version_up_to_date'] = 'Tu instalación esta actualizada a fecha, no hay actualizaciones disponibles para tu versión de PNphpBB.';
$lang['Version_not_up_to_date'] = 'Tu instalación parece que <b>NO</b> esta actualizada. Hay actualizaciones disponibles para tu versión de PNphpBB, por favor visita <a href="http://www.pnphpbb.com" target="_new">http://www.pnphpbb.com</a> para obtener la última versión.';
$lang['Latest_version_info'] = 'La última versión disponible es <b>PNphpBB %s</b>.';
$lang['Current_version_info'] = 'Tú estas usando <b>PNphpBB %s</b>.';
$lang['Connect_socket_error'] = 'Incapaz de abrir conexión con el Servidor PNphpBB, error reportado es:<br />%s';
$lang['Socket_functions_disabled'] = 'Incapaz de usar funciones socket.';
$lang['Mailing_list_subscribe_reminder'] = 'Para las ultimas noticias en actualizaciones de PNphpBB, por favor visita <a href="http://www.pnphpbb.com" target="_new">http://www.pnphpbb.com</a>.';
$lang['Version_information'] = 'Información de Versión';

//
// Login attempts configuration
//
$lang['Max_login_attempts'] = 'Intentos permitidos de conexión/login';
$lang['Max_login_attempts_explain'] = 'El número de conexiones/logins permitidos en el foro.';
$lang['Login_reset_time'] = 'Tiempo de bloqueo de login';
$lang['Login_reset_time_explain'] = 'Tiempo en minutos que el usuario tiene que esperar hasta que se le permite el login otra vez después de exceder el numero permitido de intengos de login/conexión.';
