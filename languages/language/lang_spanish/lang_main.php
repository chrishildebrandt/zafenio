...
//
// Deberia tambien intentar configurar locale y codificación de caracteres (mas dirección). La codificación y dirección serán
// enviados a la plantilla. El locale puede que funcione o no, depende del soporte del Sistema Operativo y la
...
$lang['Board_disable'] = 'Lo sentimos pero momentaneamente este foro no se encuentra disponible, por favor intentelo de nuevo más tarde';
...
$lang['Rules_post_cannot'] = '<b>No Puede</b> publicar nuevos temas en este foro';
...
$lang['Empty_poll_title'] = 'Debe escribir un título para su encuesta';
...
$lang['Already_voted'] = 'Tú ya has votado en esta encuesta.';
$lang['No_vote_option'] = 'Debes especificar una opción al votar.';
...
$lang['You_no_new_pm'] = 'No tiene nuevos mensajes privados';
...
$lang['Display_messages'] = 'Mostrar mensajes anteriores desde'; // Followed by number of days/weeks/months
...
$lang['Avatar'] = 'Avatar';
$lang['Avatar_explain'] = 'Muestra una pequeña imagen bajo sus detalles en los mensajes. Solo una imagen puede ser mostrada a la vez, su ancho no puede ser mayor que %d pixels, y su altura no mayor que %d pixels y el tamaño de archivo no mas de %d KB.'; 
$lang['Upload_Avatar_file'] = 'Enviar Avatar desde su PC';
...
$lang['Use_Gravatar'] = 'Activar Gravatar';
...
$lang['Agree_under_13'] = 'Estoy de acuerdo con estos términos y soy <b>menor</b> de 13 años de edad';
$lang['Agree_over_13'] = 'Estoy de acuerdo con estos términos y soy <b>mayor</b> de 13 años de edad';
$lang['Agree_not'] = 'No estoy de acuerdo con estos terminos';
...
//
$lang['Confirm_code_wrong'] = 'El código de confirmación que introdujiste era incorrecto';
$lang['Too_many_registers'] = 'Has excedido el número de intetos de registro para esta sesión. Por favor, intentalo de nuevo más adelante.';
$lang['Confirm_code_impaired'] = 'Si la imagen esta deterioriada o no puedes leer este código, por favor, contacta con el %sAdministrador%s para ayuda.';
$lang['Confirm_code'] = 'Código de confirmación';
$lang['Confirm_code_explain'] = 'Introduce el código exactamente tal y como lo ves. El código es sensible y el cero tiene una línea diagonal a través de ella.';
...
$lang['Search_Flood_Error'] = 'No puedes realizar otra búsqueda tan pronto después de tu última; por favor, intentalo de nuevo en un tiempo.';
...
$lang['You_been_banned'] = 'Se le ha restringido el acceso a este foro<br />Por favor contacte con el webmaster o el administrador del foro para mayor información';
...
//
$lang['All_times'] = 'Todas las horas son %s'; // ej. Todas las horas son GMT - 12 Horas (horas para el siguiente bloque)
...
$lang['Admin_reauthenticate'] = 'Para administrar el foro debes re-autoentificarte.';
$lang['Login_attempts_exceeded'] = 'El número máximo de %s intentos de login han sido excedidos. No puedes intentar loguearte hasta pasados %s minutos.';
$lang['Please_remove_install_contrib'] = 'Por favor, asegurate de que el directorio /install es eliminado';
