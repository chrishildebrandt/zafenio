...
$lang['Topics_marked_read'] = 'Le discussioni di questo forum sono state segnate come già lette';
...
$lang['No_longer_watching'] = 'Non stai più controllando questa discussione';
...
$lang['Forum_locked'] = 'Questo forum è chiuso. Non puoi inserire, rispondere o modificare le discussioni';
...
$lang['HTML_is_OFF'] = 'HTML è <u>DISATTIVO</u>';

$lang['BBCode_is_ON'] = '%sBBCode%s è <u>ATTIVO</u>'; // %s are replaced with URI pointing to FAQ

$lang['BBCode_is_OFF'] = '%sBBCode%s è <u>DISATTIVO</u>';
...
$lang['Always_notify_explain'] = 'Manda una email quando qualcuno risponde ad una discussione a cui hai risposto. Questo può essere cambiato ogni volta che inserisci un nuovo messaggio.';
...
$lang['Avatar_explain'] = 'Mostra una piccola immagine grafica sotto i tuoi dettagli nel messaggio. Può essere mostrata una sola immagine alla volta, la sua larghezza massima è di %d pixel, l\'altezza di %d pixel e il file deve essere più piccolo di %dkB.';
...
$lang['Avatar_imagesize'] = 'L\'avatar deve essere più piccolo di %d pixel di larghezza e di %d pixel di altezza';
...
$lang['Group_hidden_members'] = 'Questo gruppo è nascosto, non puoi vedere i suoi utenti';
...
$lang['Already_member_group'] = 'Sei già un utente di questo gruppo';

$lang['User_is_member_group'] = 'E\' già un utente di questo gruppo';
...
$lang['Could_not_anon_user'] = 'L\'utente anonimo non può essere utente di un gruppo';
...
$lang['This_closed_group'] = 'Questo è un gruppo chiuso, non si accettano altri utenti';
...
$lang['Guest_user_online'] = 'C\'è %d visitatore in linea'; // There is 1 Guest user online
...
$lang['No_Topics_Moved'] = 'Non è stato spostato nessuna discussione';
...
$lang['Topic_split'] = 'La discussione selezionata è stata divisa con successo';
